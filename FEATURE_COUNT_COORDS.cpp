...
/*---------------------------------------------------------------------------
 ...
 and a feature file generated by gff_parse4.sh outputs counts per feature (as 
 stdout) and count metrics for all accession IDs in feature  file
 ----------------------------------------------------------------------------*/


static string usage = "Usage: FEATURE_COUNT_COORDS <path to coordinate input file> <path to feature input file>  <path to metrics outupt file> <path to input accession file> <paired only option>\n " ;
