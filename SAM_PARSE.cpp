...
/*---------------------------------------------------------------------------
 This program takes in a SAM file sorted by ID and outputs a file for each accession ID
 of 1) coordinate positions and strand orientations of all reads aligning to that accession 
 and 2) alignment metrics  
 ----------------------------------------------------------------------------*/


static string usage = "Usage: SAM_PARSE <path to SAM input file sorted by ID> <path to coordinate output file>  <path to metrics outupt file> <path to accession output file> <rev alignment option>\n " ;
